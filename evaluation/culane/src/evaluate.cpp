...
#pragma omp parallel for
	for (int i = 0; i < filelists.size(); i++)
	{
		...
		string full_im_name = im_dir + sub_im_name.substr(0, sub_im_name.find_first_of(".")) + ".jpg";
		string sub_txt_name =  sub_im_name.substr(0, sub_im_name.find_first_of(".")) + ".lines.txt";
